...
$ret=mysqli_query($con,"insert into admin(username,password) values('$username','$password')");
...
$_SESSION['errmsg']="Sucessfully registered";
				...
				<div class="module module-login span4 offset4">
					<form class="form-vertical" method="post">
						<div class="module-head">
							<h3>Registraion (Grevince commitee) </h3>
						</div>
						<span style="color:red;" ><?php echo htmlentities($_SESSION['errmsg']); ?><?php echo htmlentities($_SESSION['errmsg']="");?></span>
						<div class="module-body">
							<div class="control-group">
								<div class="controls row-fluid">
									<input class="span12" type="text" id="fullName1" name="FN" placeholder="Fullname">
								</div>
							</div>
              <div class="control-group">
								<div class="controls row-fluid">
